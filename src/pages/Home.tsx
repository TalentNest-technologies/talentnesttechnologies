        ...
        <div className="container mx-auto px-4 py-32 relative z-30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-40">
              <Button asChild variant="hero" size="lg" className="relative z-50 shadow-glow">
                <Link to="/contact">
                  Request a Demo <ArrowRight className="ml-2" />
                </Link>
              </Button>
              <Button asChild size="lg" className="bg-white border-2 border-white text-foreground hover:bg-white/90 relative z-50 shadow-lg font-semibold">
