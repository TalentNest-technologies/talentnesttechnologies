    ...
    <div className="min-h-screen relative">
        ...
        <div className="container mx-auto px-4 py-32 relative z-30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/80 mb-8 leading-relaxed">
              Powerful platforms for recruitment, property management, and hospitality operations. Trusted by leading
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4">End-to-End IT Solutions</h2>
          </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4">Leading Hotel Brands</h2>
          </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            {clients.map((client) => (
              <div
                key={client}
                className="text-2xl font-heading font-bold text-muted-foreground/50 hover:text-foreground smooth-transition"
              >
                {client}
              </div>
            ))}
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4">Built for Scale and Security</h2>
          </div>
      ...
      <section className="py-24 bg-foreground text-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6">Ready to Transform Your Operations?</h2>
